...
describe('Notes', () => {
  ...
  describe('selectedNote store', () => {
    ...
    it('SELECT returns the provided payload', () => {
      let newNote = selectedNoteReducer(undefined, NoteActions.selectNote(_.cloneDeep(NOTE)));
  ...
  describe('notes store', () => {
    ...
    it('GET_ALL', () => {
      let newNotes = notesReducer([], NoteActions.getAll(initialState));
    ...
    it('CREATE', () => {
      ...
      let newNotes = notesReducer(initialState, NoteActions.createNote(newNote));
    ...
    it('UPDATE', () => {
      ...
      let newNotes = notesReducer(initialState, NoteActions.updateNote(_.cloneDeep(changedNote)));
    ...
    it('DELETE', () => {
      ...
      let newNotes = notesReducer(initialState, NoteActions.deleteNote(deletedNote));
